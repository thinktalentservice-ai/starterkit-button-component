...
const SOURCE = "https://cdn.thinktalentws48.click/starterkit/colors_and_type.css";
...
const sheet = await fetch(SOURCE).then((res) => {
...
const block = `${START}
/* Source: ${SOURCE} — regenerate with \`pnpm sync:tokens\`.
